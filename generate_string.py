...
def generate_trade_list(trade_list = "", string_const = "&!traded&!shiny&!favorite&!rocket&!4*&!#", include_evo_line = True):
...
if __name__ == "__main__":
	my_trade_list = """
 	...
 	"""
	generate_trade_list(my_trade_list, string_const = "&!traded&!shiny&!favorite&!rocket&!4*&!#", include_evo_line = True)
